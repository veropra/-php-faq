...
<html lang="en" dir="ltr">
  ...
  <header>
    <div class="header_container">
      ...
      <p class="near_logo">Privacy e termini</p>
      <ul class="header_list">
        <li>Introduzione</li>
        <li>Norme sulla privacy</li>
        <li>Termini di servizio</li>
        <li>Tecnologie</li>
        <li class="end_li">Domande frequenti</li>
      </ul>
      <p>Account Google</p>
    </div>
  </header>
    ...
    <div class="text_container">
      <?php
       ...
       foreach ($Myarray as $key => $value) {
        ?>
         <h2 class="domanda">
        <?php print $value["domanda"];?>
        </h2>
         <p class="risposta">
        <?php print $value["risposta"];?>
        </p>
        <?php
       }
       ?>
  ...
  <footer class="footer_container">
    <div class="bg">
      ...
      <button class="footer_button">Italiano</button>
  </footer>
</body>
</html>
